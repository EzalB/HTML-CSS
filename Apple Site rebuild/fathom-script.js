window.fathom = function() {
    ...
    return fathomScript.src.indexOf("cdn.usefathom.com") < 0 && ((scriptUrl = document.createElement("a")).href = fathomScript.src, trackerUrl = "https://" + scriptUrl.hostname + "/"), auto && setTimeout(function() {
        ...
        trackPageview: function(params) {
            ...
            var hostname, location = window.location;
            void 0 === params.url ? canonical && document.querySelector('link[rel="canonical"][href]') && ((hostname = document.createElement("a")).href = document.querySelector('link[rel="canonical"][href]').href, location = hostname) : (location = document.createElement("a")).href = params.url, "" !== location.host && (hostname = location.protocol + "//" + location.hostname, this.send({
